...
class Graphsage(torch.nn.Module):
    ...
    def create_net(self, name, input_dim, **kw):
        ...
        for i in range(num_layers):
            ...
            if i:
                conv = dgl.nn.pytorch.conv.SAGEConv(in_feats=hidden_dim, out_feats=hidden_dim,aggregator_type="gcn")
            else:
                conv = dgl.nn.pytorch.conv.SAGEConv(in_feats=input_dim, out_feats=hidden_dim,aggregator_type="gcn")
