    ...
    for weight in range(len(adj_self_weight)):
        ...
        for times in range(5):
            ...
            if train_config["pretrain_model"] == "GIN":
                pre_train_model_d = GIN(train_config["node_feature_dim"],train_config["gcn_hidden_dim"],train_config)
            ...
            for count in range(train_config["few_shot_tasknum"]):
                ...
                model_0.load_state_dict(torch.load(os.path.join(save_pretrain_model_dir, "best_local_%s_times%d.pt"%(record[adj_self_weight[weight]],times))),strict = False)
